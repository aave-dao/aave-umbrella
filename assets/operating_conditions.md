...
- Calculating the number of tokens that can be distributed per year: `1000 * 60 * 60 * 24 * 365 ≈ 31,536,000,000`. This means approximately _31.54 billion tokens per year_.
- If the price of the reward token is at least 0.01 USD, the total value of rewards would be approximately _315.36 million USD annually_.
